                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="namawisata" type="text" class="form-control" name="namawisata" tabindex="1" required autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="informasi" name="informasi" rows="1"></textarea>
                                                        </div>
                                                        <div class="invalid-feedback">
